...
![Screenshot 19: Showing Kibana Service Status](images/21-kibana-service-status.png)

*Figure 19: Kibana service status confirming that Kibana started successfully and is running on the Kali Linux system.*
